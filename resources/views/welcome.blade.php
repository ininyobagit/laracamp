                    ...
                    <div class="col-lg-6 col-12">
                        <div class="table-pricing paket-gila">
                            ...
                            <p>
                                <a
                                    href="{{
                                        route('checkout.create', 'gila-belajar')
                                    }}"
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="table-pricing paket-biasa">
                            ...
                            <p>
                                <a
                                    href="{{
                                        route('checkout.create', 'baru-mulai')
                                    }}"
                ...
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="item-review">
                            ...
                            />
                            <p class="message">
                                I was not really into code but after they teach
                                me how to train my logic then I was really fall
                                in love with code
                            </p>
                            <div class="user">
                                <img
                                    src="{{ asset('/images/fanny_photo.png') }}"
                                    class="photo"
                                    alt=""
                                />
                                <div class="info">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="item-review">
                            ...
                            />
                            <p class="message">
                                Code is really important if we want to build a
                                company and strike to the win
                            </p>
                            <div class="user">
                                <img
                                    src="{{ asset('/images/angga.png') }}"
                                    class="photo"
                                    alt=""
                                />
                                <div class="info">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="item-review">
                            ...
                            />
                            <p class="message">
                                My background is design and art but I do really
                                love how to make my design working in the
                                development phase
                            </p>
                            <div class="user">
                                <img
                                    src="{{ asset('/images/beatrice.png') }}"
                                    class="photo"
                                    alt=""
                                />
                                <div class="info">
