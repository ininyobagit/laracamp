                    ...
                    <div class="col-lg-11 col-12">
                        <div class="row">
                            <div class="col-lg-6 col-12 copywriting">
                                ...
                                <p class="support">
                                    Our bootcamp is helping junior developers
                                    who <br />
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12">
                        <div class="item-benefit">
                            <img
                                src="{{ asset('/images/ic_globe-1.png') }}"
                                class="icon"
                                alt=""
                            />
                    ...
                    <div class="col-lg-3 col-12">
                        <div class="item-benefit">
                            <img
                                src="{{ asset('/images/ic_globe-2.png') }}"
                                class="icon"
                                alt=""
                            />
                    ...
                    <div class="col-lg-3 col-12">
                        <div class="item-benefit">
                            <img
                                src="{{ asset('/images/ic_globe-3.png') }}"
                                class="icon"
                                alt=""
                            />
            ...
            <div class="container">
                ...
                <div class="row item-step pb-70">
                    <div class="col-lg-6 col-12 text-left copywriting pl-150">
                        ...
                        <p class="support">
                            Each of you will be joining the private group and
                            also <br />
                    ...
                    <div class="col-lg-10 col-12">
                        <div class="row">
                            <div class="col-lg-4 col-12">
                                <div class="item-review">
                                    <img
                                        src="{{ asset('/images/stars.svg') }}"
                                        alt=""
                                    />
                                    <p class="message">
                                        I was not really into code but after
                                        they teach me how to train my logic then
                                        I was really fall in love with code
                                    </p>
                                    <div class="user">
                                        <img
                                            src="{{
                                                asset('/images/fanny_photo.png')
                                            }}"
                                            class="photo"
                                            alt=""
                                        />
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="item-review">
                                    ...
                                    />
                                    <p class="message">
                                        Code is really important if we want to
                                        build a company and strike to the win
                                    </p>
                                    <div class="user">
                                        <img
                                            src="{{
                                                asset('/images/angga.png')
                                            }}"
                                            class="photo"
                                            alt=""
                                        />
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="item-review">
                                    ...
                                    />
                                    <p class="message">
                                        My background is design and art but I do
                                        really love how to make my design
                                        working in the development phase
                                    </p>
                                    <div class="user">
                                        <img
                                            src="{{
                                                asset('/images/beatrice.png')
                                            }}"
                                            class="photo"
                                            alt=""
                                        />
                        ...
                        <div class="row copyright">
                            <div class="col-lg-12 col-12">
                                <p>
                                    All Rights Reserved. Copyright Laracamp BWA
                                    Indonesia.
                                </p>
                            </div>
                        </div>
